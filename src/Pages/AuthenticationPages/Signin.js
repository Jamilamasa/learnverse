    ...
    <>
      <div className="flex h-screen w-full">
        ...
        <div className="lg:w-3/5 h-screen w-full lg:py-10">
          ...
          <form
            className="lg:px-[30%] px-10 lg:py-16 flex flex-col gap-4 py-3  lg:gap-[1.6rem]"
            onSubmit={handleSubmit}
          >
            <div className=" relative">
              <label
                htmlFor="username"
                className="bg-white text-[#343434B2] absolute text-sm top-[-10px] left-[20px]"
              >
                Email
              </label>
              ...
              <input
                ...
                type="email"
                className="w-full border-2 border-[#67949E] py-4 px-5 rounded-full "
                name="email"
            ...
            <div className=" relative">
              <label
                htmlFor="username"
                className="text-[#343434B2] bg-white absolute text-sm top-[-10px] left-[20px]"
              >
                Password
              </label>
            ...
            <div className="flex justify-end">
              <p className="text-[#EA4335]">Forgot password?</p>
            </div>
            ...
            <p className="text-center text-xs">
              ...
              <span className="font-bold">Term and Condition</span>
            </p>
          </form>
        </div>
      </div>
